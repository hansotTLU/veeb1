...
window.onload = function(){
	// document.getElementById("photoSubmit")  - Saab ka nii
	// document.querySelector(".photoSubmit") - css'iga oleks nii
	// document.querySelector("div") - ei mäleta millega nii oleks
